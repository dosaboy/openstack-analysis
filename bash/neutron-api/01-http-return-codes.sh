...
expr1="s,$EXPR_LOG_DATE $EXPR_LOG_CONTEXT \\\"(GET|POST|HEAD|DELETE|PUT) /[a-z0-9.]+/[^/]+\?.*[/ ].+\" status: ([0-9]+) .+,\2,p"
expr2="s,$EXPR_LOG_DATE_GROUP_TIME $EXPR_LOG_CONTEXT \\\"(GET|POST|HEAD|DELETE|PUT) /[a-z0-9.]+/[^/]+\?.*[/ ].+\\\" status: \$INSERT .+,\1,p"
